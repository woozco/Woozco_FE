...
export async function postBoardRequest(postBoardData: PostBoardData): Promise<void>{
    try {
        const response: AxiosResponse = await apiInstance.post('/board/create', postBoardData);
...
export async function getAllBoard(): Promise<AxiosResponse<PostBoardData[]>> {
    try {
        const response: AxiosResponse = await apiInstance.get('/board/all');
...
export async function getPostById(postId: number): Promise<void>{
    try {
        const response: AxiosResponse = await apiInstance.get(`/board/${postId}`);
        console.log('GET 요청 성공:', response.data);
      } catch (error) {
        console.error('GET 요청 오류:', error);
      }
...
export async function postUpdateBoardRequest(postUpdateBoardData: PostBoardData): Promise<void>{
    try {
        ...
        const response: AxiosResponse = await apiInstance.post(`/board/${postId}/update`, postUpdateBoardData);
        console.log('POST 요청 성공:', response.data);
    } catch (error) {
        console.error('POST 요청 오류:', error);
    }
...
export async function deleteBoard(postId: number): Promise<void>{
    try {
        const response: AxiosResponse = await apiInstance.delete(`/board/${postId}/delete`);
